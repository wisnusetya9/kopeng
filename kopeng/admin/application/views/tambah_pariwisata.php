					...
					<div class="row">
						<div class="col-md-12">
							<div class="box box-primary">
								...
								<form role="form" action="<?php echo site_url("master_data/pariwisata_tambah_proses"); ?>" method="post" enctype="multipart/form-data" id="form_tambah" name="form_tambah">
									<div class="box-body">
										...
										<div class="form-group">
											<label for="file_foto">Foto <b style="color: red;">*</b></label> <?php if (isset($error["file_foto"])) { ?><small class="label label-danger"><?php echo $error["file_foto"]; ?></small><?php } ?>
											<input type="file" id="file_foto" name="file_foto" accept="image/jpg, image/jpeg, image/png" required />
										</div>
									</div>
