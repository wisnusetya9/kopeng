...
<html>
	...
	<body class="hold-transition skin-blue sidebar-mini">
		<div class="wrapper">
			...
			<div class="content-wrapper">
				<section class="content-header">
					<a class="btn btn-primary pull-right" href="<?php echo site_url("master_data/pariwisata_tambah"); ?>">Tambah Data</a>
					<h1>
						Master Data
						...
						<div class="col-md-12">
							<div class="box box-primary">
								<div class="box-body">
									...
									<?php } ?>
									<table id="tbl_pariwisata" class="table table-bordered table-hover">
										<thead>
											<tr>
												<th>No.</th>
												<th>Nama Lokasi</th>
		...
		<script>
			...
			$(function() {
				var tbl_pariwisata = $("#tbl_pariwisata").DataTable({
					"columnDefs": [{
						"searchable": false,
						"orderable": false,
						"targets": [0, 4]
					...
					"serverSide": true,
					"ajax": {
						url: "<?php echo site_url("ajax/get_all_pariwisata"); ?>",
						type: "POST",
						error: function() {
							$("#tbl_pariwisata_processing").css("display", "none");
						}
					},
					"dom": "<\"pull-left\"f><\"pull-left\"l><\"pull-left\"r><<t>ip>"
				});
				tbl_pariwisata.on("draw.dt", function () {
					var page = tbl_pariwisata.page.info().page;
					var length = tbl_pariwisata.page.info().length;
					tbl_pariwisata.column(0, {
						search: "applied", 
						order: "applied"
				...
				$("#btn_modal_hapus").click(function() {
					window.location.href = "<?php echo site_url("master_data/pariwisata_hapus_proses"); ?>/" + id_pariwisata;
				});
			});
			
			function hapus(id_hapus) {
				id_pariwisata = id_hapus;
